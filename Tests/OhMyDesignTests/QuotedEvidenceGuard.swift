...
struct QuotedEvidenceGuard {
    ...
    private nonisolated static let citations: [(doc: String, source: String, quote: String)] = [
        ...
        ("docs/component-registry.json", "Sources/OhMyDesign/Components/Tree/TreeCore.swift", "public nonisolated enum TreeRowClickBehavior: Hashable, Sendable, CaseIterable {"),
        ...
        ("docs/components/tree.md", "Sources/OhMyDesign/Components/Tree/Tree.swift", "func searchFilter(_ query: String, text: @escaping (Data.Element) -> String) -> Tree"),
        ("docs/components/tree.md", "Sources/OhMyDesign/Components/Tree/Tree.swift", "func rowClickBehavior(_ behavior: TreeRowClickBehavior) -> Tree"),
        ("docs/components/tree.md", "Sources/OhMyDesign/Components/Tree/TreeCore.swift", "public nonisolated enum TreeRowClickBehavior: Hashable, Sendable, CaseIterable {"),
        ("docs/components/tree.md", "Sources/OhMyDesign/Components/Tree/TreeInteraction.swift", "pointerClick"),
        ("docs/components/tree.md", "Tests/OhMyDesignTests/TreeTests.swift", "TreeRowClickBehaviorTests"),
        ("docs/components/tree.md", "Sources/OhMyDesign/Components/Tree/TreeSearch.swift", "init(verbatim content: String, highlighting query: String)"),
        ("docs/components/tree.md", "Sources/OhMyDesign/Colors/InteractionColors.swift", "searchMatchBackground"),
