...
struct ComponentExtensionPointGuard {
    ...
    func semanticComponentsHaveExtensionPoint() throws {
        ...
        #expect(result.inspected.count == 17,
                "J-2 定义域实测 17 条（ActivityHeatmap/AvatarGroup/Banner/BeforeAfterSlider/FormField/NetworkGraph/OrbitingLogos/ProgressIndicator/RadarChart/Rating/RatingDisplay/RingChart/SegmentedControl/SpinningModifier/Steps/Timeline/Toast），实际 \(result.inspected.count) 条：\(result.inspected)")
